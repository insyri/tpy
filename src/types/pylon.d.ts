...
export namespace KV {
  ...
  export namespace OperationOptions {
    ...
    export interface Put {
      /**
       * The duration in milliseconds until the key should expire. Mutually
       * exclusive with `ttlEpoch`.
       */
      ttl?: number;
      /**
    ...
    export interface Items {
      /**
       * Returns keys after `from`. Meaning, if you had the keys `["a", "b", "c"]`
       * in the namespace, calling `kv.items({from: "a"})` would return the items
       * for the keys `["b", "c"]`.
       */
      from?: string;
      /**
    ...
    export interface List {
      /**
       * Returns keys after `from`. Meaning, if you had the keys `["a", "b", "c"]`
       * in the namespace, calling `kv.list({from: "a"})` would return `["b", "c"]`.
       */
      from?: string;
      /**
       * The number of keys to return in the list call.
 ...
 */
export namespace PylonWebSocket {
  /**
